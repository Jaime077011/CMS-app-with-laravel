          ...
          <div class="col-12">
            ...
            <div class="card-columns">
              ...
              <div class="card">
                <a href="#" class="link_poet">
                  <div class="cover_link">
                    <img class="main_img" src="../../assets/website/img/inner/px0654.jpg" class="card-img-top" alt="...">
                    <div class="auther_post">
                      <div class="media">
                        <img src="../../assets/website/img/persons/23.jpg" alt="">
              ...
              <div class="card">
                <a href="#" class="link_poet">
                  <div class="cover_link">
                    <img class="main_img" src="../../assets/website/img/inner/01219874.jpg" class="card-img-top" alt="...">
                    <div class="auther_post">
                      <div class="media">
                        <img src="../../assets/website/img/persons/23.jpg" alt="">
                        <div class="media-body my-auto">
              ...
              <div class="card">
                <a href="#" class="link_poet">
                  <div class="cover_link">
                    <img class="main_img" src="../../assets/website/img/inner/00pxsd.jpg" class="card-img-top" alt="...">
                    <div class="auther_post">
                      <div class="media">
                        <img src="../../assets/website/img/persons/23.jpg" alt="">
                        <div class="media-body my-auto">
              ...
              <div class="card">
                <a href="#" class="link_poet">
                  <div class="cover_link">
                    <img class="main_img" src="../../assets/website/img/inner/pxx065.jpg" class="card-img-top" alt="...">
                    <div class="auther_post">
                      <div class="media">
                        <img src="../../assets/website/img/persons/23.jpg" alt="">
                        <div class="media-body my-auto">
              ...
              <div class="card">
                <a href="#" class="link_poet">
                  <div class="cover_link">
                    <img class="main_img" src="../../assets/website/img/inner/00vupo.jpg" class="card-img-top" alt="...">
                    <div class="auther_post">
                      <div class="media">
                        <img src="../../assets/website/img/persons/23.jpg" alt="">
                        <div class="media-body my-auto">
